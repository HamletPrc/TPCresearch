...
void ReadGas(const char *filename) {
    ...
    cout << "E = " << ex << "V/cm,  Vx = " << vx << "cm/us, to drift 20cm, t = " << t << "us, 0,1V/cm fluctuation, dt = " << t1 << "ns, 1V/cm fluctuation, dt = " << t2 << "ns, \%1 fluctuation, dt = " << t3 << "ns, \%10 fluctuation, dt = " << t4 << endl;
